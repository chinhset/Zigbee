...
/***************************************************
Function: convertIndexPtoValueP(BYTE p)
This function for converting from a number in BYTE
to Power (dB)
It use the configuration of tranceiver, use to recover
the real power when receive power in a number (BYTE)
***************************************************/
...
/***************************************************
Function: convertValuePtoIndexP(float a)
This function for converting from a Power value (dB) to
a number (BYTE)
It use the configuration of tranceiver, use to transmit
the power beetwin two node
***************************************************/
BYTE convertValuePtoIndexP(float a1){
		  float a = -a1;
          BYTE *p,c =0x00,d;
          p = (BYTE*)&a;
          p+=3;
...
float getmetrics(BYTE LQIhear,DWORD Tpass, BYTE Ptdes) { //@Son53 tinh metric
    float metriclink;
