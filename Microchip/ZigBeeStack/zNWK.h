...
typedef struct _ROUTE_DISCOVERY_ENTRY
{
    ...
    BYTE           forwardmetric[4]; //Ghi lai metric tinh duoc trong qua trinh Request
    BYTE           residualmetric[4];//Ghi lai metric trinh duoc trong qua trinh Reply
    BYTE           indexforwardPt;   //Cong suat phat mong muon tinh duoc o node nhan
    BYTE           indexrealPt;      //Gia tri cong suat phat thuc te
#endif
